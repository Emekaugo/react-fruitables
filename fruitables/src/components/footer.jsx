            ...
            <div className="row g-4">
              ...
              <div className="col-lg-3">
                <div className="d-flex justify-content-end pt-3">
                  <a
                    className="social-media btn btn-outline-secondary me-2 btn-md-square rounded-circle"
                    href=""
                  >
                  ...
                  <a
                    className="social-media btn btn-outline-secondary btn-md-square rounded-circle"
                    href=""
                  >
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <img
                  src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQ3jM2P9QT0Ww5akuL15d_vlK1Qr-WPZp6uwYTu9pG3yE0CEqeK"
                  className="img-fluid"
                  alt="img-payment"
                />
              </div>
